...
export const SRC_EXTENSION_DIR = path.resolve(SRC_DIR, './extension');
export const POPUP_SRC_DIR = path.resolve(SRC_EXTENSION_DIR, './popup');
...
export const ICONS_SRC_DIR = path.resolve(SRC_EXTENSION_DIR, './icons');

export const CONTENT_SRC_DIR = path.resolve(SRC_EXTENSION_DIR, './content');
export const CONTENT_SCRIPT_SRC = path.resolve(SRC_EXTENSION_DIR, './content/content');

export const BACKGROUND_SRC_DIR = path.resolve(SRC_EXTENSION_DIR, './background');
export const BACKGROUND_SCRIPT_SRC = path.resolve(SRC_EXTENSION_DIR, './background/background');
